<template>
	<div class="content" :style='{"alignContent":"flex-start","overflow":"hidden","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","height":"auto"}'>
			...
			<div :style='{"width":"30%","padding":"0 0px","flexWrap":"wrap","display":"flex"}'>
				<div class="tables">
					...
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"rgba(0,205,215,.3)","borderStyle":"solid","borderWidth":"1px 0 0 0px","background":"none"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="dianpu" label="店铺"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="leibie" label="类别"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="chandi" label="商品产地"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="maozhong" label="商品毛重"/>
						</el-table-column>
					</el-table>
				</div>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","padding":"0 16px","background":"url() no-repeat center top / 100% 100%","height":"calc(100% - 40px)"}'>
						<div id="jianfeiChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"40%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div v-if="systemIntroductionDetail" :style='{"padding":"0","margin":"0 0 20px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"calc(50% - 180px)","order":"2"}'>
					<el-carousel :style='{"width":"50%","margin":"0 auto"}' trigger="click" indicator-position="inside" arrow="always" type="default" direction="horizontal" height="100%" :autoplay="true" :interval="6000" :loop="true">
						<el-carousel-item :style='{"borderRadius":"10px","width":"100%","height":"100%"}' v-if="systemIntroductionDetail.picture1">
							<el-image :style='{"width":"100%","objectFit":"cover","borderRadius":"50%","height":"100%"}' :src="$base.url+ systemIntroductionDetail.picture1" fit="cover"></el-image>
						</el-carousel-item>
						<el-carousel-item :style='{"borderRadius":"10px","width":"100%","height":"100%"}' v-if="systemIntroductionDetail.picture2">
							<el-image :style='{"width":"100%","objectFit":"cover","borderRadius":"50%","height":"100%"}' :src="$base.url+ systemIntroductionDetail.picture2" fit="cover"></el-image>
						</el-carousel-item>
						<el-carousel-item :style='{"borderRadius":"10px","width":"100%","height":"100%"}' v-if="systemIntroductionDetail.picture3">
							<el-image :style='{"width":"100%","objectFit":"cover","borderRadius":"50%","height":"100%"}' :src="$base.url+ systemIntroductionDetail.picture3" fit="cover"></el-image>
						</el-carousel-item>
					</el-carousel>
					<div :style='{"padding":"0 10px","margin":"0 0 0 20px","borderColor":"#fff","color":"#666","textIndent":"2em","overflow":"hidden","borderRadius":"20%","flex":1,"background":"#fff","borderWidth":"20px 40px","lineHeight":"1.6","fontSize":"14px","borderStyle":"solid","height":"100%"}' v-html="systemIntroductionDetail.content"></div>
				</div>
				<!-- 统计 -->
				<div :style='{"padding":"0","margin":"10px auto 20px","color":"#666","alignItems":"center","display":"flex","justifyContent":"center","alignContent":"center","background":"none","width":"98%","fontSize":"14px","height":"130px","order":"1","zIndex":"9"}'>
					...
					<div :style='{"border":"4px groove #6dedfe","margin":"0 2% 0 0","alignItems":"center","borderRadius":"50% 60%","background":"url() no-repeat center top / 100% 100%","flexDirection":"column","display":"flex","width":"18%","justifyContent":"center","height":"100%"}'>
						...
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>食品总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"26px","color":"#333","fontWeight":"bold","height":"32px"}'>{{jianfeiCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts2">
					...
					<div :style='{"width":"100%","padding":"0 16px","height":"calc(100% - 40px)"}'>
						<div id="jianfeiChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"30%","padding":"0 0px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","padding":"0 16px","height":"calc(100% - 40px)"}'>
						<div id="jianfeiChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","padding":"0 16px","margin":"0 0 0px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20240201/49e2bd5a42f94890935fc4619090a954.png) no-repeat left center,url(http://codegen.caihongy.cn/20240201/49e2bd5a42f94890935fc4619090a954.png) no-repeat right center,url(http://codegen.caihongy.cn/20240201/b8af7cb3d8d145a29f398fd9e69f0f89.png) repeat-x center center","height":"40px"}'>
					...
					<div :style='{"width":"100%","padding":"0 16px","height":"calc(100% - 40px)"}'>
						<div id="jianfeiChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
export default {
	data() {
		return {
			...
			bar: {"backgroundColor":"transparent","yAxis":{"axisLabel":{"borderType":"solid","rotate":0,"padding":0,"shadowOffsetX":0,"margin":12,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#2a8288","shadowBlur":0,"show":true,"inside":false,"ellipsis":"...","overflow":"none","borderRadius":0,"borderWidth":0,"width":"","fontSize":12,"lineHeight":24,"shadowColor":"transparent","fontWeight":"normal","height":"","Interval":0},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#2a828880","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#2a828880","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"minInterval":1,"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#2a8288","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(250,250,250,0.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"xAxis":{"axisLabel":{"borderType":"solid","rotate":0,"padding":0,"shadowOffsetX":0,"margin":4,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#2a8288","shadowBlur":0,"show":true,"inside":false,"borderRadius":0,"borderWidth":0,"width":"","fontSize":12,"lineHeight":24,"shadowColor":"transparent","fontWeight":"normal","height":"","Interval":0},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#2a8288","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#2a8288","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":false},"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#2a8288","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(255,255,255,.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"color":["#2c99de","#28bbed","#60d3e3","#98dcb3","#ffd650","#ffa373","#ff7e91","#30dc75"],"legend":{"padding":[0,10,0,0],"itemGap":5,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"orient":"horizontal","shadowBlur":0,"bottom":"auto","itemHeight":12,"show":true,"icon":"roundRect","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"inherit","shadowOffsetY":0,"color":"inherit","shadowBlur":0,"borderWidth":0,"opacity":1,"shadowColor":"transparent"},"right":"auto","top":"auto","borderRadius":0,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"inherit","shadowBlur":0,"width":"auto","type":"inherit","opacity":1,"shadowColor":"transparent"},"left":"right","borderWidth":0,"width":"80%","itemWidth":12,"textStyle":{"textBorderWidth":0,"color":"inherit","textShadowColor":"transparent","ellipsis":"...","overflow":"none","fontSize":12,"lineHeight":14,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"transparent","textShadowBlur":0},"shadowColor":"rgba(0,0,0,.3)","height":"auto"},"grid":{"x":"10%","y":"15%","y2":"15%","x2":"5%"},"series":{"barWidth":"12px","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"#2a8288","shadowOffsetY":0,"color":"","shadowBlur":0,"borderWidth":0,"barBorderRadius":[20,20,0,0],"opacity":1,"shadowColor":"#000"},"colorBy":"data","color":{"x":0,"y":0,"y2":1,"x2":0,"colorStops":[{"offset":0,"color":"#b7eef1"},{"offset":0.3,"color":"#b7eef1"},{"offset":0.6,"color":"#21c9d4"},{"offset":1,"color":"#2a8288"}],"type":"linear"},"barCategoryGap":"20%"},"tooltip":{"backgroundColor":"#333","textStyle":{"color":"#fff"}},"title":{"borderType":"solid","padding":[5,0,0,10],"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"shadowBlur":0,"bottom":"auto","show":false,"right":"auto","top":"0","borderRadius":0,"left":"left","borderWidth":0,"textStyle":{"textBorderWidth":0,"color":"#2a8288","textShadowColor":"transparent","fontSize":14,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"#ccc","textShadowBlur":0},"shadowColor":"transparent"},"base":{"animate":false,"interval":2000}},
			bar2: {"backgroundColor":"transparent","yAxis":{"axisLabel":{"borderType":"solid","rotate":0,"padding":0,"shadowOffsetX":0,"margin":12,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#2a8288","shadowBlur":0,"show":true,"inside":false,"ellipsis":"...","overflow":"none","borderRadius":0,"borderWidth":0,"width":"","fontSize":12,"lineHeight":24,"shadowColor":"transparent","fontWeight":"normal","height":""},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#b5eaf6","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#b5eaf6","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"minInterval":1,"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#b5eaf6","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(250,250,250,0.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"xAxis":{"axisLabel":{"borderType":"solid","rotate":0,"padding":0,"shadowOffsetX":0,"margin":4,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#2a8288","shadowBlur":0,"show":true,"inside":false,"ellipsis":"...","overflow":"none","borderRadius":0,"borderWidth":0,"width":"","fontSize":12,"lineHeight":24,"shadowColor":"transparent","fontWeight":"normal","height":""},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#b5eaf6","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#b5eaf6","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":false},"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#b5eaf6","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(255,255,255,.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"color":["#00ff00","#91cc75","#fac858","#ee6666","#73c0de","#3ba272","#fc8452","#9a60b4","#ea7ccc"],"legend":{"padding":[5,15,0,0],"itemGap":10,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"orient":"horizontal","shadowBlur":0,"bottom":"auto","itemHeight":14,"show":true,"icon":"roundRect","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"inherit","shadowOffsetY":0,"color":"inherit","shadowBlur":0,"borderWidth":0,"opacity":1,"shadowColor":"transparent"},"right":"auto","top":"auto","borderRadius":0,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"inherit","shadowBlur":0,"width":"auto","type":"inherit","opacity":1,"shadowColor":"transparent"},"left":"right","borderWidth":0,"width":"auto","itemWidth":25,"textStyle":{"textBorderWidth":0,"color":"inherit","textShadowColor":"transparent","ellipsis":"...","overflow":"none","fontSize":12,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"transparent","textShadowBlur":0},"shadowColor":"rgba(0,0,0,.3)","height":"auto"},"grid":{"x":"20%","y":"15%","y2":"15%","x2":"5%"},"series":{"barWidth":"12px","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"#33c3e6","shadowOffsetY":0,"color":"","shadowBlur":0,"borderWidth":0,"barBorderRadius":[0,20,20,0],"opacity":1,"shadowColor":"#000"},"colorBy":"data","color":{"x":1,"y":0,"y2":0,"x2":0,"colorStops":[{"offset":0,"color":"#a0e8ba"},{"offset":0.5,"color":"#65f4ca"},{"offset":1,"color":"#33c3e6"}],"type":"linear"},"barCategoryGap":"20%"},"tooltip":{"backgroundColor":"#333","textStyle":{"color":"#fff"}},"title":{"borderType":"solid","padding":2,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"shadowBlur":0,"bottom":"auto","show":false,"right":"auto","top":"auto","borderRadius":0,"left":"left","borderWidth":0,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","fontSize":14,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"#ccc","textShadowBlur":0},"shadowColor":"transparent"},"base":{"animate":false,"interval":2000}},
			...
			boardBase: {"funnelNum":8,"lineNum":6,"gaugeNum":8,"barNum":10,"pieNum":8},
...
//统计接口1
    jianfeiChat2() {
      this.$nextTick(()=>{
        ...
        var jianfeiChart2 = echarts.init(document.getElementById("jianfeiChart2"),'macarons');
        this.$http({
            url: `jianfei/value/title/price`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                jianfeiChart2.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    jianfeiChart2.resize();
                },false);
            }
        });
      })
...
//统计接口2
    jianfeiChat4() {
      this.$nextTick(()=>{
        ...
        var jianfeiChart4 = echarts.init(document.getElementById("jianfeiChart4"),'macarons');
        this.$http({
            url: "jianfei/group/dianpu",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                jianfeiChart4.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    jianfeiChart4.resize();
                },false);
            }
        });
      })
...
//统计接口3
    jianfeiChat3() {
      this.$nextTick(()=>{
        ...
        var jianfeiChart3 = echarts.init(document.getElementById("jianfeiChart3"),'macarons');
        this.$http({
            url: "jianfei/group/chandi",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                jianfeiChart3.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    jianfeiChart3.resize();
                },false);
            }
        });
      })
...
//统计接口4
    jianfeiChat1() {
      this.$nextTick(()=>{
        ...
        var jianfeiChart1 = echarts.init(document.getElementById("jianfeiChart1"),'macarons');
        this.$http({
            url: "jianfei/group/leibie",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                jianfeiChart1.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    jianfeiChart1.resize();
				},false);
            }
        });
      })
